import{a as L,S as w,i as r}from"./assets/vendor-CucEYOFD.js";(function(){const o=document.createElement("link").relList;if(o&&o.supports&&o.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))l(a);new MutationObserver(a=>{for(const s of a)if(s.type==="childList")for(const i of s.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&l(i)}).observe(document,{childList:!0,subtree:!0});function e(a){const s={};return a.integrity&&(s.integrity=a.integrity),a.referrerPolicy&&(s.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?s.credentials="include":a.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function l(a){if(a.ep)return;a.ep=!0;const s=e(a);fetch(a.href,s)}})();const b="https://pixabay.com/api/",v="38535962-5f658dcdecdcf7989cf195384";async function P(t,o){const e={q:t,image_type:"photo",orientation:"horizontal",safesearch:!0,page:o,per_page:p,key:v},{data:l}=await L.get(b,{params:e});return l}const f=document.querySelector(".loader"),g=document.querySelector(".gallery"),y=document.querySelector(".cant-load-more"),u=document.querySelector(".load-more"),S={captionsData:"alt",captionDelay:250,className:"lightbox-custom"},M=new w(".open-modal-link",S);function E(t){const o=t.map(e=>`
      ...
      </li>`).join("");g.insertAdjacentHTML("beforeend",o),M.refresh()}function q(){g.innerHTML=""}function k(){f.classList.remove("hidden")}function x(){f.classList.add("hidden")}function B(){u.classList.remove("hidden")}function m(){u.classList.add("hidden")}function O(){y.classList.remove("hidden")}function $(){y.classList.add("hidden")}const I=document.querySelector(".form"),p=15;let n=1,c=null;I.addEventListener("submit",_);u.addEventListener("click",A);async function _(t){if(t.preventDefault(),c=t.target.elements["search-text"].value.trim(),c.length<=0){d("empty search","error");return}q(),n=1,await h()}async function A(t){const o=document.querySelector(".gallery").getBoundingClientRect().bottom;n++,await h(),window.scrollBy({top:o,behavior:"smooth"})}function d(t,o="success"){const e={message:t,position:"topRight",timeoot:5e3};switch(o){case"success":r.success(e);break;case"error":r.error(e);break;case"warning":r.warning(e);break;case"info":r.info(e);break;default:r.error({...e,message:"invalid type of tosat"});break}}async function h(){k();try{const{hits:t,totalHits:o}=await P(c,n);t.length<=0?d("Sorry, there are no images matching your search query. Please try again!","warning"):E(t);const e=Math.ceil(o/p);n<e?(B(),$()):(m(),O())}catch(t){console.log("Error on createNewPage",t),d("Sorry, there was an error getting images. Please try again!","error"),m()}finally{x()}}
